									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Products" />
											</div>
										</div>
										<div class="card-toolbar">
											<a href="addProduct.php?new=1" class="btn btn-primary btn-sm">Add Product</a>
										</div>
									</div>
									<div class="card-body pt-0">
										<table class="table align-middle table-row-dashed fs-6 gy-5 table-bordered" id="kt_ecommerce_category_table">
											...
											<tbody class="fw-bold text-gray-600">
											    ...
											    <?$products=getAll($con,"select * from ecommerce_products order by timeAdded desc");
											    foreach($products as $row){?>
											    
												<tr>
												    <td style="text-align: center;"><?echo $row['title']?></td>
													<td style="text-align: center;"><?echo $row['category']?></td>
													<td style="text-align: center;"><?echo $row['rating']?></td>
													<td style="text-align: center;"><?echo $row['price']?></td>	
													<td style="text-align: center;">
														<a class="btn btn-<?echo $color?> btn-sm" href="?serviceId=<?echo $row['id']?>&displayType=<?echo $displayType?>"><?echo $text?></a>
														<a href="addProduct.php?productId=<?echo $row['id']?>" class="btn btn-warning btn-sm">Edit</a>
