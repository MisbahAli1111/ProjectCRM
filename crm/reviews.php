...
if(isset($_GET['delete-product'])){
    ...
    $query="delete from ecommerce_review where id='$id'";
    runQuery($query);
    header("Location:?m=Review deleted successfully");
}
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Reviews" />
											</div>
										</div>
									...
									<div class="card-body pt-0">
										<table class="table align-middle table-row-dashed fs-6 gy-5 table-bordered" id="kt_ecommerce_category_table">
											...
											<tbody class="fw-bold text-gray-600">
											    ...
											    <?$products=getAll($con,"select * from ecommerce_review order by added_on desc");
												...
												<?php
													...
													<td style="text-align: center;"><?echo $row['review']?></td>
													<td style="text-align: center;"><?echo date('Y-m-d H:i:s',$row['added_on'])?></td>
													<td style="text-align: center;">
